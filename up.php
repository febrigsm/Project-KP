...
<html lang="en">
  ...
  <section id="container" class="">  
    ...
    <li class="sub-menu">
      ...
      <ul class="sub">
        <li><a class="" href="RegUser.php">Register</a></li>
        <li><a class="" href="ListUser.php">List</a></li>
      </ul>
   </li>
   <li class="sub-menu">
      <a href="javascript:;" class="">
      ...
      <ul class="sub">
        <li><a class="" href="ListKlasBppka.php">Klasifikasi Bppka</a></li>
        <li><a class="" href="ListTujBppka.php">Tujuan Bppka</a></li>
        <li><a class="" href="ListKlasSekda.php">Klasifikasi Sekda</a></li>
        <li><a class="" href="ListTujSekda.php">Tujuan Sekda</a></li>
      </ul>
   </li>
      </ul>
      <!-- sidebar menu end-->
