...
include"../koneksi.php";
$panggil=$_GET['id'];
$cari2=mysql_query("select * from suratkeluar where NOK='$panggil' ");
...
<form class="form form-horizontal" method="post" action="saveBppkaSK.php">
  <div class="form-group"><br/>
  <label class="col-sm-2 control-label">Nomor</label>
    <div class="col-sm-10">
    <input type="text" name="no" value="<?php echo"$hasil2[NOK]";?>" class="form-control" placeholder="">
    </div>
    </div>
  ...
  <label class="col-sm-2 control-label">No Agenda</label>
    <div class="col-sm-10">
    <input type="text" name="noAgenda" class="form-control" placeholder="">
    </div>
    </div>
    <div class="form-group">
  <label class="col-sm-2 control-label">Pengirim</label>
    <div class="col-sm-10">
    <input type="text" name="pengirimDisposisi" class="form-control" placeholder="">
    </div>
    </div>
    <div class="form-group">
...
<form class="form form-horizontal" method="post" action="saveSekdaSK.php">
  <div class="form-group">
  <br/>
  <label class="col-sm-2 control-label">Nomor</label>
    <div class="col-sm-10">
  ...
  <label class="col-sm-2 control-label">Tanggal Teriam</label>
    ...
    <label class="col-sm-2 control-label">No Agenda</label>
    <div class="col-sm-10">
    <input type="text" name="noAgenda2" class="form-control" placeholder="">
    </div>
    </div>
    <div class="form-group">
  <label class="col-sm-2 control-label">Pengirim</label>
    <div class="col-sm-10">
    <input type="text" name="pengirimDisposisi2" class="form-control" placeholder="">
    </div>
    </div>
    <div class="form-group">
  <label class="col-sm-2 control-label">Diteruskan</label>
