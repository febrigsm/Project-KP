...
include '../up.php';
$panggil=$_GET['id'];
$cari=mysql_query("select * from dispokeluar where NO_DISPOSISIK='$panggil' ");
...
<div class="col-lg-12">
  ...
  <div class="tab-pane active" id="BPPKA">
    <form class="form form-horizontal" method="post" action="editBppkaSK.php">
    ...
    <label class="col-sm-2 control-label">Nomor Disposisi</label>
      <div class="col-sm-10">
      <input type="text" name="noDisposisi" value="<?php echo"$hasil[NO_DISPOSISIK]";?>" class="form-control" placeholder="">
      </div>
      </div>
      <div class="form-group">
    <label class="col-sm-2 control-label">Tanggal Surat</label>
      <div class="col-sm-10">
      <input type="date" name="Kirimdisposisi" value="<?php echo"$hasil[KIRIM_DISPOSISIK]";?>" class="form-control" placeholder=""> 
      </div>
      </div>
      <div class="form-group">
    <label class="col-sm-2 control-label">Tanggal Terima</label>
      <div class="col-sm-10">
      <input type="date" name="Terimadisposisi" value="<?php echo"$hasil[TERIMA_DISPOSISIK]";?>" class="form-control" placeholder="">
      </div>
      </div>
      <div class="form-group">
    <label class="col-sm-2 control-label">No Agenda</label>
      <div class="col-sm-10">
      <input type="text" name="noAgenda" value="<?php echo"$hasil[NO_AGENDAK]";?>" class="form-control" placeholder="">
      </div>
      </div>
      <div class="form-group">
    <label class="col-sm-2 control-label">Pengirim</label>
      <div class="col-sm-10">
      <input type="text" name="pengirimDisposisi" value="<?php echo"$hasil[PENGIRIM_DISPOSISIK]";?>" class="form-control" placeholder="">
      </div>
      </div>
      <div class="form-group">
    <label class="col-sm-2 control-label">Diteruskan</label>
      <div class="col-md-3"> 
      <?php 
        $terpilih2=$hasil["TUJUAN_DISPOSISIK"];
    ...
    <label class="col-sm-2 control-label">Klasifikasi</label>
      <div class="col-md-3"> 
      <?php 
        $terpilih=$hasil["KLASIFIKASI_DISPOSISIK"];
    ...
    <label class="col-sm-2 control-label">Isi Saran/Disposisi</label>
      <div class="col-sm-10">                      
      <input type="text" name="disposisi" value="<?php echo"$hasil[DISPOSISIK]";?>" class="form-control" placeholder="">  
      </div>
      </div><br>
      <div class="form-group">
