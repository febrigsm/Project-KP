...
if(in_array($file_ext, $allowed_ext) === true){
  if($file_size < 104857600){
    ...
    if(!move_uploaded_file($file_tmp, $lokasi)){
      ...
      $target = $data[0];
      $in = mysql_query("UPDATE suratkeluar SET NO_SURATK='$noSurat',TANGGAL_SURATK='$tglSurat',TANGGAL_KIRIMK='$kirim',SIFATK='$sifat',TUJUAN_SURATK='$tujuan',PERIHAL_SURATK='$perihal', NO_AGENDAK='$noAgenda',KET='$keterangan',FILE2='$lokasi',TIPE_FILE2='$file_ext' where NOK='$no'") or die(mysql_error());
      if($in){
