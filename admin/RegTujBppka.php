...
<li><i class="icon_document_alt"></i><a href="ListTujBppka.php">List Tujuan Bppka</a></li>					  	
</ol>
</div>
</div>
<div class="row">
<div class="col-lg-12">
<section class="panel">
<header class="panel-heading">Form Register Tujuan Bppka</header>
<div class="panel-body">
  <form class="form-horizontal " method="post" action="saveTujBppka.php">
