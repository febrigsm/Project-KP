...
mysql_query ("update disposisisekda set NO='$no',JENIS_DISPOSISI1='$jenis',KIRIM_DISPOSISI1='$Kirimdisposisi',TERIMA_DISPOSISI1='$Terimadisposisi',NO_AGENDA1='$noAgenda',TUJUAN_DISPOSISI1='$selected_2',KLASIFIKASI_DISPOSISI1='$selected_1',DISPOSISI1='$disposisi' where NO_DISPOSISI1='$noDisposisi'");
