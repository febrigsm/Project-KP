...
include"../koneksi.php";
$id_user=$_GET['id'];
$cari=mysql_query("select * from klasifikasi where ID_KLAS='$id_user'");
...
<form class="form-horizontal " action="editKlasBppka.php?id=<?php echo $hasil['ID_KLAS']?>"  method="post">
  <div class="form-group">
  <label class="col-sm-2 control-label">Nama</label>
    <div class="col-sm-10">
    <input type="text" name="nama_bppka" value="<?php echo"$hasil[NAMA_KLAS]";?>" class="form-control" placeholder="">
    </div>
    </div>
