...
mysql_query ("update disposisibppka set  NO='$no',JENIS_DISPOSISI='$jenis',KIRIM_DISPOSISI='$Kirimdisposisi',TERIMA_DISPOSISI='$Terimadisposisi',NO_AGENDA='$noAgenda',TUJUAN_DISPOSISI='$selected_2',KLASIFIKASI_DISPOSISI='$selected_1',DISPOSISI='$disposisi' where NO_DISPOSISI='$noDisposisi'");
