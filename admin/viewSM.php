...
<tr><th width="1000px">
<a href="regDisSM.php?id=<?php echo"$_GET[id]";?>"><button type="submit" class="btn btn-primary">&nbsp;</i>+Disposisi</button></a></th>
...
<table class="table table-striped table-advance table-hover" border="1">
  ...
  <?php
    include"../koneksi.php";
    $panggil=$_GET['id'];
    $Query=mysql_query("SELECT * FROM disposisibppka WHERE NO='$panggil'");
    $no=1;
    ...
    <tr>
      ...
      <a href="formeditDispo.php?id=<?php echo"$n[NO_DISPOSISI]";?>">Edit</a>
      <a href="delDisSM.php?id=<?php echo"$_GET[id]&id_dis=$n[NO_DISPOSISI]";?>">| Hapus</a>
      </div></td>
    </tr>
 <?php } ?>     
 ...
 <?php
  $panggil=$_GET['id'];
  $query=mysql_query("SELECT * FROM disposisisekda WHERE NO='$panggil'");
  ...
  <tr>
    ...
    <td><div class="btn-group">
    <a href="formeditDispo1.php?id=<?php echo"$m[NO_DISPOSISI1]";?>">Edit</a>
    <a href="delDisSM.php?id=<?php echo"$_GET[id]&id_dis=$m[NO_DISPOSISI1]";?>"> | Hapus</a>
    </div></td>
  </tr>
  <?php } ?>
  </tbody>
