...
include '../up.php';
$panggil=$_GET['id'];
$cari2=mysql_query("select * from disposisisekda where NO_DISPOSISI1='$panggil' ");
$hasil2=mysql_fetch_array($cari2);
?>

  <li><i class="icon_document_alt"></i><a href="ViewSM.php">List Surat Masuk</a></li>
  </ol>
 </div>
</div>
<div class="row">
<div class="col-lg-12">
 <section class="panel">
 <header class="panel-heading">Form Edit Disposisi Sekda</header>
 ...
 <ul class="nav nav-tabs">
    ...
    <div class="tab-pane active" id="SEKDA">
      ...
      <label class="col-sm-2 control-label">No Agenda</label>
        <div class="col-sm-10">
        <input type="text" name="noAgenda2" value="<?php echo"$hasil2[NO_AGENDA1]";?>" class="form-control" placeholder="">
        </div>
        </div>
