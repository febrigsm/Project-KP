...
include"../koneksi.php";
$panggil=$_GET['id'];
$cari=mysql_query("select * from disposisi2 where NO_DISPOSISI='$panggil' ");
      ...
      <form class="form form-horizontal" method="post" action="editBppka.php">
       ...
       <label class="col-sm-2 control-label">Tanggal Surat</label>
        ...
        <label class="col-sm-2 control-label">Pengirim</label>
          <div class="col-sm-10">
          <input type="text" name="pengirimDisposisi" value="<?php echo"$hasil[PENGIRIM_DISPOSISI]";?>" class="form-control" placeholder="">
          </div>
          </div>
          <div class="form-group">
