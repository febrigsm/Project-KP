...
$input2="INSERT INTO disposisi2(NO,NO_DISPOSISI,JENIS_DISPOSISI,KIRIM_DISPOSISI,TERIMA_DISPOSISI,NO_AGENDA,PENGIRIM_DISPOSISI, TUJUAN_DISPOSISI, KLASIFIKASI_DISPOSISI,DISPOSISI) 
VALUES ('$no','$noDisposisi','$jenis','$Kirimdisposisi','$Terimadisposisi','$noAgenda','$pengirimDisposisi','$selected_2','$selected_1','$disposisi')";
