    ...
    if($file_size < 104857600){
      ...
      if(!move_uploaded_file($file_tmp, $lokasi)){
        echo '<div class="error">ERROR: Gagal Coy!</div>';
           ...
           $in = mysql_query("INSERT INTO suratkeluar VALUES('','$noSM','$tglSM', '$kirimSK','$sifat','$kepada','$perihal', '$agenSK', '$ketSK','$tgl', '$nama', '$file_ext', '$file_size', '$lokasi')") or die(mysql_error());
           if($in){
               $id=mysql_insert_id();
