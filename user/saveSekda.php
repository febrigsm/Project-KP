...
$input2="INSERT INTO disposisi1(NO,NO_DISPOSISI1,JENIS_DISPOSISI1,KIRIM_DISPOSISI1,TERIMA_DISPOSISI1,NO_AGENDA1,PENGIRIM_DISPOSISI1, TUJUAN_DISPOSISI1, KLASIFIKASI_DISPOSISI1, DISPOSISI1) 
VALUES ('$no','$noDisposisi','$jenis','$Kirimdisposisi','$Terimadisposisi','$noAgenda','$pengirimDisposisi','$selected_3','$selected_4','$disposisi')";
