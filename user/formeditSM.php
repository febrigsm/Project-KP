...
include"../koneksi.php";
$panggil=$_GET['id'];
$cari=mysql_query("select * from surat2 where NO='$panggil' ");
...
<form class="form-horizontal " method="post" action="saveEditSM.php" enctype="multipart/form-data">
  ...
  <label class="col-sm-2 control-label">Tujuan Surat</label>
    <div class="col-sm-10">
    <input type="text" name="tujuanSM_isi" value="<?php echo"$hasil[TUJUAN_SURAT]";?>" class="form-control" placeholder="">
    </div>
    </div>
    <div class="form-group">
  ...
  <label class="col-sm-2 control-label">Nama File</label>
    <div class="col-sm-10">
    <input type="text" name="nama_file" required value="<?php echo $hasil['nama_file'] ?>" class="form-control">
    </div>
    </div>  
    <div class="form-group">
