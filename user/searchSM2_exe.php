...
<table class="table table-striped table-advance table-hover" border="1">
  ...
  <?php
    ...
    $sql = mysql_query("SELECT * FROM surat2 INNER JOIN disposisi2 ON surat2.NO = disposisi2.NO where TANGGAL_SURAT between '$tgl1' AND '$tgl2' ORDER BY TANGGAL_SURAT ASC");
